...
BooleanPropertyRNA rna_ExplodeModifier_use_edge_split;
...
BooleanPropertyRNA rna_ShrinkwrapModifier_use_cull_back_faces;
BooleanPropertyRNA rna_ShrinkwrapModifier_use_cull_front_faces;
...
BooleanPropertyRNA rna_SolidifyModifier_use_rim_material;
...
void ExplodeModifier_use_edge_split_set(PointerRNA *ptr, int value)
{
	ExplodeModifierData *data= (ExplodeModifierData*)(ptr->data);
	if(value) data->flag |= 4;
	else data->flag &= ~4;
...
{
	ShrinkwrapModifierData *data= (ShrinkwrapModifierData*)(ptr->data);
	return (((data->shrinkOpts) & 16) != 0);
}

void ShrinkwrapModifier_use_cull_back_faces_set(PointerRNA *ptr, int value)
{
	ShrinkwrapModifierData *data= (ShrinkwrapModifierData*)(ptr->data);
	if(value) data->shrinkOpts |= 16;
	else data->shrinkOpts &= ~16;
}

int ShrinkwrapModifier_use_cull_front_faces_get(PointerRNA *ptr)
{
	ShrinkwrapModifierData *data= (ShrinkwrapModifierData*)(ptr->data);
	return (((data->shrinkOpts) & 8) != 0);
}

void ShrinkwrapModifier_use_cull_front_faces_set(PointerRNA *ptr, int value)
{
	ShrinkwrapModifierData *data= (ShrinkwrapModifierData*)(ptr->data);
	if(value) data->shrinkOpts |= 8;
	else data->shrinkOpts &= ~8;
}
...
void SolidifyModifier_use_rim_material_set(PointerRNA *ptr, int value)
{
	SolidifyModifierData *data= (SolidifyModifierData*)(ptr->data);
	if(value) data->flag |= 16;
	else data->flag &= ~16;
...
/* Explode Modifier */
BooleanPropertyRNA rna_ExplodeModifier_show_alive = {
	{(PropertyRNA*)&rna_ExplodeModifier_show_dead, NULL,
...
BooleanPropertyRNA rna_ExplodeModifier_show_dead = {
	{(PropertyRNA*)&rna_ExplodeModifier_protect, (PropertyRNA*)&rna_ExplodeModifier_show_alive,
	-1, "show_dead", 3, "Dead",
...
FloatPropertyRNA rna_ExplodeModifier_protect = {
	{(PropertyRNA*)&rna_ExplodeModifier_use_size, (PropertyRNA*)&rna_ExplodeModifier_show_dead,
...
BooleanPropertyRNA rna_ExplodeModifier_use_size = {
	{(PropertyRNA*)&rna_ExplodeModifier_use_edge_split, (PropertyRNA*)&rna_ExplodeModifier_protect,
	-1, "use_size", 3, "Size",
...
BooleanPropertyRNA rna_ExplodeModifier_use_edge_split = {
	{(PropertyRNA*)&rna_ExplodeModifier_show_unborn, (PropertyRNA*)&rna_ExplodeModifier_use_size,
	-1, "use_edge_split", 3, "Split Edges",
	"Split face edges for nicer shrapnel",
	0,
	PROP_BOOLEAN, PROP_NONE|PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Modifier_update, 0, NULL, NULL,
	0, -1, NULL},
	ExplodeModifier_use_edge_split_get, ExplodeModifier_use_edge_split_set, NULL, NULL, 0, NULL
};

BooleanPropertyRNA rna_ExplodeModifier_show_unborn = {
	{(PropertyRNA*)&rna_ExplodeModifier_vertex_group, (PropertyRNA*)&rna_ExplodeModifier_use_edge_split,
...
/* Shrinkwrap Modifier */
PointerPropertyRNA rna_ShrinkwrapModifier_auxiliary_target = {
	{(PropertyRNA*)&rna_ShrinkwrapModifier_use_cull_back_faces, NULL,
...
BooleanPropertyRNA rna_ShrinkwrapModifier_use_cull_back_faces = {
	{(PropertyRNA*)&rna_ShrinkwrapModifier_use_cull_front_faces, (PropertyRNA*)&rna_ShrinkwrapModifier_auxiliary_target,
	-1, "use_cull_back_faces", 3, "Cull Back Faces",
	"Stop vertices from projecting to a back face on the target",
	0,
	PROP_BOOLEAN, PROP_NONE|PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Modifier_update, 0, NULL, NULL,
	0, -1, NULL},
	ShrinkwrapModifier_use_cull_back_faces_get, ShrinkwrapModifier_use_cull_back_faces_set, NULL, NULL, 0, NULL
};

BooleanPropertyRNA rna_ShrinkwrapModifier_use_cull_front_faces = {
	{(PropertyRNA*)&rna_ShrinkwrapModifier_use_keep_above_surface, (PropertyRNA*)&rna_ShrinkwrapModifier_use_cull_back_faces,
	-1, "use_cull_front_faces", 3, "Cull Front Faces",
	"Stop vertices from projecting to a front face on the target",
	0,
	PROP_BOOLEAN, PROP_NONE|PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Modifier_update, 0, NULL, NULL,
	0, -1, NULL},
	ShrinkwrapModifier_use_cull_front_faces_get, ShrinkwrapModifier_use_cull_front_faces_set, NULL, NULL, 0, NULL
};

BooleanPropertyRNA rna_ShrinkwrapModifier_use_keep_above_surface = {
	{(PropertyRNA*)&rna_ShrinkwrapModifier_wrap_method, (PropertyRNA*)&rna_ShrinkwrapModifier_use_cull_front_faces,
...
FloatPropertyRNA rna_SolidifyModifier_edge_crease_inner = {
	{(PropertyRNA*)&rna_SolidifyModifier_offset, (PropertyRNA*)&rna_SolidifyModifier_use_quality_normals,
...
FloatPropertyRNA rna_SolidifyModifier_offset = {
	{(PropertyRNA*)&rna_SolidifyModifier_edge_crease_outer, (PropertyRNA*)&rna_SolidifyModifier_edge_crease_inner,
	-1, "offset", 8195, "Offset",
...
FloatPropertyRNA rna_SolidifyModifier_edge_crease_rim = {
	{(PropertyRNA*)&rna_SolidifyModifier_use_rim_material, (PropertyRNA*)&rna_SolidifyModifier_edge_crease_outer,
...
BooleanPropertyRNA rna_SolidifyModifier_use_rim_material = {
	...
	-1, "use_rim_material", 3, "Rim Material",
	"Use in the next material for rim faces",
	0,
	PROP_BOOLEAN, PROP_NONE|PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Modifier_update, 0, NULL, NULL,
	0, -1, NULL},
	SolidifyModifier_use_rim_material_get, SolidifyModifier_use_rim_material_set, NULL, NULL, 0, NULL
};

FloatPropertyRNA rna_SolidifyModifier_thickness = {
	{(PropertyRNA*)&rna_SolidifyModifier_vertex_group, (PropertyRNA*)&rna_SolidifyModifier_use_rim_material,
