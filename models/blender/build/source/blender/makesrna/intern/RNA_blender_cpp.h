...
public:
	...
	/* Min Angle: Minimum angle to maintain with target direction. No correction is done if angle with target direction is between min and max */
	float angle_min(void);
	/* Max Angle: Maximum angle allowed with target direction. No correction is done if angle with target direction is between min and max */
	float angle_max(void);
	/* Distance: Height of the Fh area */
	float fh_height(void);
	/* Fh: Spring force within the Fh area */
	float spring(void);
...
public:
	...
	/* Minimum Limit */
	Array<float, 6> limit_generic_min(void);
	/* Maximum Limit */
	Array<float, 6> limit_generic_max(void);
	/* Minimum Limit */
	Array<float, 3> limit_cone_min(void);
	/* Maximum Limit */
	Array<float, 3> limit_cone_max(void);
	/* Use X Limit: Use minimum/maximum x limit */
	bool use_limit_x(void);
	/* Use Y Limit: Use minimum/maximum y limit */
	bool use_limit_y(void);
	/* Use Z Limit: Use minimum/maximum z limit */
	bool use_limit_z(void);
	/* Use Angular X Limit: Use minimum/maximum x angular limit */
	bool use_angular_limit_x(void);
	/* Use Angular Y Limit: Use minimum/maximum y angular limit */
	bool use_angular_limit_y(void);
	/* Use Angular Z Limit: Use minimum/maximum z angular limit */
...
public:
	...
	float protect(void);
	/* Split Edges: Split face edges for nicer shrapnel */
	bool use_edge_split(void);
...
public:
	...
	/* Cull Front Faces: Stop vertices from projecting to a front face on the target */
	bool use_cull_front_faces(void);
	/* Cull Back Faces: Stop vertices from projecting to a back face on the target */
	bool use_cull_back_faces(void);
	/* Keep Above Surface */
...
public:
	...
	bool use_rim(void);
	/* Rim Material: Use in the next material for rim faces */
	bool use_rim_material(void);
...
public:
	...
	/* Use Material Physics: Use physics settings in materials */
	bool use_material_physics(void);
...
/**************** Implementation ****************/
	...
	FLOAT_PROPERTY(ConstraintActuator, spring)
	...
	FLOAT_ARRAY_PROPERTY(RigidBodyJointConstraint, 6, limit_generic_min)
	FLOAT_ARRAY_PROPERTY(RigidBodyJointConstraint, 6, limit_generic_max)
	FLOAT_ARRAY_PROPERTY(RigidBodyJointConstraint, 3, limit_cone_min)
	FLOAT_ARRAY_PROPERTY(RigidBodyJointConstraint, 3, limit_cone_max)
	...
	BOOLEAN_PROPERTY(MaterialPhysics, use_normal_align)
	FLOAT_PROPERTY(MaterialPhysics, friction)
	FLOAT_PROPERTY(MaterialPhysics, force)
	FLOAT_PROPERTY(MaterialPhysics, elasticity)
	FLOAT_PROPERTY(MaterialPhysics, distance)
	FLOAT_PROPERTY(MaterialPhysics, damping)
	...
	BOOLEAN_PROPERTY(ExplodeModifier, use_edge_split)
	...
	BOOLEAN_PROPERTY(ShrinkwrapModifier, use_cull_front_faces)
	BOOLEAN_PROPERTY(ShrinkwrapModifier, use_cull_back_faces)
	...
	BOOLEAN_PROPERTY(SolidifyModifier, use_rim_material)
	...
	BOOLEAN_PROPERTY(GameObjectSettings, use_material_physics)
