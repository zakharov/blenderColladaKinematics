...
/* Context */
PointerPropertyRNA rna_Context_rna_type = {
	{(PropertyRNA*)&rna_Context_rna_properties, NULL,
...
CollectionPropertyRNA rna_Context_rna_properties = {
	{(PropertyRNA*)&rna_Context_area, (PropertyRNA*)&rna_Context_rna_type,
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	Context_rna_properties_begin, Context_rna_properties_next, Context_rna_properties_end, Context_rna_properties_get, NULL, NULL, rna_builtin_properties_lookup_string, &RNA_Property
};

PointerPropertyRNA rna_Context_area = {
	{(PropertyRNA*)&rna_Context_blend_data, (PropertyRNA*)&rna_Context_rna_properties,
	-1, "area", 0, "area",
	"",
	0,
	PROP_POINTER, PROP_NONE|PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
PointerPropertyRNA rna_Context_blend_data = {
	{(PropertyRNA*)&rna_Context_mode, (PropertyRNA*)&rna_Context_area,
...
EnumPropertyRNA rna_Context_mode = {
	{(PropertyRNA*)&rna_Context_region, (PropertyRNA*)&rna_Context_blend_data,
	-1, "mode", 2, "mode",
	"",
	0,
...
PointerPropertyRNA rna_Context_region = {
	{(PropertyRNA*)&rna_Context_region_data, (PropertyRNA*)&rna_Context_mode,
	-1, "region", 0, "region",
	"",
	0,
	PROP_POINTER, PROP_NONE|PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
PointerPropertyRNA rna_Context_region_data = {
	{(PropertyRNA*)&rna_Context_scene, (PropertyRNA*)&rna_Context_region,
...
PointerPropertyRNA rna_Context_scene = {
	{(PropertyRNA*)&rna_Context_screen, (PropertyRNA*)&rna_Context_region_data,
	-1, "scene", 0, "scene",
	"",
	0,
	PROP_POINTER, PROP_NONE|PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
PointerPropertyRNA rna_Context_screen = {
	{(PropertyRNA*)&rna_Context_space_data, (PropertyRNA*)&rna_Context_scene,
	-1, "screen", 0, "screen",
	"",
	0,
	PROP_POINTER, PROP_NONE|PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
PointerPropertyRNA rna_Context_space_data = {
	{(PropertyRNA*)&rna_Context_tool_settings, (PropertyRNA*)&rna_Context_screen,
...
PointerPropertyRNA rna_Context_tool_settings = {
	{(PropertyRNA*)&rna_Context_user_preferences, (PropertyRNA*)&rna_Context_space_data,
...
PointerPropertyRNA rna_Context_user_preferences = {
	{(PropertyRNA*)&rna_Context_window, (PropertyRNA*)&rna_Context_tool_settings,
...
PointerPropertyRNA rna_Context_window = {
	{(PropertyRNA*)&rna_Context_window_manager, (PropertyRNA*)&rna_Context_user_preferences,
	-1, "window", 0, "window",
	"",
	0,
	PROP_POINTER, PROP_NONE|PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
PointerPropertyRNA rna_Context_window_manager = {
	{NULL, (PropertyRNA*)&rna_Context_window,
...
StructRNA RNA_Context = {
	{(ContainerRNA *)&RNA_ControlFluidSettings, (ContainerRNA *)&RNA_ConstraintTarget,
	NULL,
	{(PropertyRNA*)&rna_Context_rna_type, (PropertyRNA*)&rna_Context_window_manager}},
	"Context"	, NULL,NULL
, 0, "Context", "Current windowmanager and data context",
	17,
