...
BooleanPropertyRNA rna_GameObjectSettings_use_material_physics;
...
void GameObjectSettings_use_material_physics_set(PointerRNA *ptr, int value)
{
	Object *data= (Object*)(ptr->data);
...
void Object_free_dupli_list_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	...
	rna_Object_free_duplilist(_self, reports);
}
...
void rna_Object_free_duplilist(struct Object *_self, ReportList *reports);
...
BooleanPropertyRNA rna_GameObjectSettings_use_collision_bounds = {
	{(PropertyRNA*)&rna_GameObjectSettings_use_material_physics, (PropertyRNA*)&rna_GameObjectSettings_show_state_panel,
...
BooleanPropertyRNA rna_GameObjectSettings_use_material_physics = {
	...
	-1, "use_material_physics", 3, "Use Material Physics",
	"Use physics settings in materials",
	0,
	PROP_BOOLEAN, PROP_NONE|PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	GameObjectSettings_use_material_physics_get, GameObjectSettings_use_material_physics_set, NULL, NULL, 0, NULL
};
...
BooleanPropertyRNA rna_GameObjectSettings_used_states = {
	{(PropertyRNA*)&rna_GameObjectSettings_velocity_max, (PropertyRNA*)&rna_GameObjectSettings_use_material_physics,
...
FunctionRNA rna_Object_create_dupli_list_func = {
	...
	"create_dupli_list", 4, "Create a list of dupli objects for this object, needs to be freed manually with free_dupli_list.",
...
FunctionRNA rna_Object_free_dupli_list_func = {
	...
	NULL,
	{NULL, NULL}},
	"free_dupli_list", 4, "Free the list of dupli objects.",
