...
BooleanPropertyRNA rna_Sound_use_memory_cache;
...
/* Sound */
BooleanPropertyRNA rna_Sound_use_memory_cache = {
	{(PropertyRNA*)&rna_Sound_filepath, NULL,
	-1, "use_memory_cache", 3, "Caching",
	"The sound file is decoded and loaded into RAM",
	0,
	PROP_BOOLEAN, PROP_NONE|PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Sound_filepath_update, 0, NULL, NULL,
	0, -1, NULL},
	Sound_use_memory_cache_get, Sound_use_memory_cache_set, NULL, NULL, 0, NULL
};

StringPropertyRNA rna_Sound_filepath = {
	{(PropertyRNA*)&rna_Sound_packed_file, (PropertyRNA*)&rna_Sound_use_memory_cache,
	...
	rna_Sound_filepath_update, 0, NULL, NULL,
	0, -1, NULL},
	Sound_filepath_get, Sound_filepath_length, Sound_filepath_set, 240, ""
};

PointerPropertyRNA rna_Sound_packed_file = {
	{NULL, (PropertyRNA*)&rna_Sound_filepath,
...
StructRNA RNA_Sound = {
	{(ContainerRNA *)&RNA_SoundActuator, (ContainerRNA *)&RNA_SolidifyModifier,
	NULL,
	{(PropertyRNA*)&rna_Sound_use_memory_cache, (PropertyRNA*)&rna_Sound_packed_file}},
	"Sound"	, NULL,NULL
, 3, "Sound", "Sound datablock referencing an external or packed sound file",
	114,
