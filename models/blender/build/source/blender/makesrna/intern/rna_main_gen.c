...
void BlendDataGroups_remove_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	...
	rna_Main_groups_remove(_self, reports, group);
}
...
void rna_Main_groups_remove(struct BlendDataGroups *_self, ReportList *reports, struct Group *group);
...
void BlendDataTexts_remove_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	...
	rna_Main_texts_remove(_self, reports, text);
}
...
void rna_Main_texts_remove(struct BlendDataTexts *_self, ReportList *reports, struct Text *text);
...
CollectionPropertyRNA rna_BlendData_images = {
	{(PropertyRNA*)&rna_BlendData_shape_keys, (PropertyRNA*)&rna_BlendData_groups,
	-1, "images", 0, "Images",
	"Image datablocks.",
	0,
	PROP_COLLECTION, PROP_NONE|PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
CollectionPropertyRNA rna_BlendData_shape_keys = {
	{(PropertyRNA*)&rna_BlendData_lamps, (PropertyRNA*)&rna_BlendData_images,
	-1, "shape_keys", 0, "Keys",
	"Key datablocks.",
	0,
	PROP_COLLECTION, PROP_NONE|PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
CollectionPropertyRNA rna_BlendData_lamps = {
	{(PropertyRNA*)&rna_BlendData_lattices, (PropertyRNA*)&rna_BlendData_shape_keys,
	-1, "lamps", 0, "Lamps",
	"Lamp datablocks.",
	0,
	PROP_COLLECTION, PROP_NONE|PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
CollectionPropertyRNA rna_BlendData_scripts = {
	{(PropertyRNA*)&rna_BlendData_sounds, (PropertyRNA*)&rna_BlendData_screens,
	-1, "scripts", 0, "Scripts",
...
CollectionPropertyRNA rna_BlendData_sounds = {
	{(PropertyRNA*)&rna_BlendData_texts, (PropertyRNA*)&rna_BlendData_scripts,
	-1, "sounds", 0, "Sounds",
	"Sound datablocks.",
	0,
	PROP_COLLECTION, PROP_NONE|PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
FunctionRNA rna_BlendDataGroups_remove_func = {
	...
	"remove", 4, "Remove a group from the current blendfile.",
...
FunctionRNA rna_BlendDataTexts_remove_func = {
	...
	"remove", 4, "Remove a text from the current blendfile.",
