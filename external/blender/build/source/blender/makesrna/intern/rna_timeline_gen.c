...
BooleanPropertyRNA rna_TimelineMarker_select;
...
/* Marker */
PointerPropertyRNA rna_TimelineMarker_rna_type = {
	{(PropertyRNA*)&rna_TimelineMarker_name, NULL,
...
StringPropertyRNA rna_TimelineMarker_name = {
	{(PropertyRNA*)&rna_TimelineMarker_camera, (PropertyRNA*)&rna_TimelineMarker_rna_type,
	-1, "name", 1, "Name",
	"",
	0,
	...
	0, -1, NULL},
	TimelineMarker_name_get, TimelineMarker_name_length, TimelineMarker_name_set, 64, ""
};

PointerPropertyRNA rna_TimelineMarker_camera = {
	{(PropertyRNA*)&rna_TimelineMarker_frame, (PropertyRNA*)&rna_TimelineMarker_name,
	-1, "camera", 1048577, "Camera",
...
IntPropertyRNA rna_TimelineMarker_frame = {
	...
	TimelineMarker_frame_get, TimelineMarker_frame_set, NULL, NULL, NULL,
	-10000, 10000, INT_MIN, INT_MAX, 1, 0, NULL
};

CollectionPropertyRNA rna_TimelineMarker_rna_properties = {
	{(PropertyRNA*)&rna_TimelineMarker_select, (PropertyRNA*)&rna_TimelineMarker_frame,
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	TimelineMarker_rna_properties_begin, TimelineMarker_rna_properties_next, TimelineMarker_rna_properties_end, TimelineMarker_rna_properties_get, NULL, NULL, rna_builtin_properties_lookup_string, &RNA_Property
};

BooleanPropertyRNA rna_TimelineMarker_select = {
	{NULL, (PropertyRNA*)&rna_TimelineMarker_rna_properties,
	-1, "select", 3, "Select",
	...
	NULL, 234881024, NULL, NULL,
	0, -1, NULL},
	TimelineMarker_select_get, TimelineMarker_select_set, NULL, NULL, 0, NULL
};

StructRNA RNA_TimelineMarker = {
	{(ContainerRNA *)&RNA_TimelineMarkers, (ContainerRNA *)&RNA_ThemeWidgetStateColors,
	NULL,
	{(PropertyRNA*)&rna_TimelineMarker_rna_type, (PropertyRNA*)&rna_TimelineMarker_select}},
	"TimelineMarker"	, NULL,NULL
, 0, "Marker", "Marker for noting points in the timeline",
	17,
