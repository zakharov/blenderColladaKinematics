...
BooleanPropertyRNA rna_Lattice_use_outside;
...
/* Lattice */
PointerPropertyRNA rna_Lattice_animation_data = {
	{(PropertyRNA*)&rna_Lattice_interpolation_type_u, NULL,
...
static EnumPropertyItem rna_Lattice_interpolation_type_u_items[4] = {
...
EnumPropertyRNA rna_Lattice_interpolation_type_u = {
	{(PropertyRNA*)&rna_Lattice_interpolation_type_v, (PropertyRNA*)&rna_Lattice_animation_data,
	...
	0, -1, NULL},
	Lattice_interpolation_type_u_get, Lattice_interpolation_type_u_set, NULL, rna_Lattice_interpolation_type_u_items, 3, 0
};

static EnumPropertyItem rna_Lattice_interpolation_type_v_items[4] = {
	{0, "KEY_LINEAR", 0, "Linear", ""},
	{1, "KEY_CARDINAL", 0, "Cardinal", ""},
	{2, "KEY_BSPLINE", 0, "BSpline", ""},
	{0, NULL, 0, NULL, NULL}
...
EnumPropertyRNA rna_Lattice_interpolation_type_v = {
	...
	rna_Lattice_update_data, 0, NULL, NULL,
	0, -1, NULL},
	Lattice_interpolation_type_v_get, Lattice_interpolation_type_v_set, NULL, rna_Lattice_interpolation_type_v_items, 3, 0
};

static EnumPropertyItem rna_Lattice_interpolation_type_w_items[4] = {
	{0, "KEY_LINEAR", 0, "Linear", ""},
	{1, "KEY_CARDINAL", 0, "Cardinal", ""},
	{2, "KEY_BSPLINE", 0, "BSpline", ""},
	{0, NULL, 0, NULL, NULL}
...
EnumPropertyRNA rna_Lattice_interpolation_type_w = {
	...
	rna_Lattice_update_data, 0, NULL, NULL,
	0, -1, NULL},
	Lattice_interpolation_type_w_get, Lattice_interpolation_type_w_set, NULL, rna_Lattice_interpolation_type_w_items, 3, 0
};

BooleanPropertyRNA rna_Lattice_use_outside = {
	{(PropertyRNA*)&rna_Lattice_points, (PropertyRNA*)&rna_Lattice_interpolation_type_w,
	...
	rna_Lattice_update_data, 0, NULL, NULL,
	0, -1, NULL},
	Lattice_use_outside_get, Lattice_use_outside_set, NULL, NULL, 0, NULL
};
...
CollectionPropertyRNA rna_Lattice_points = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	Lattice_points_begin, Lattice_points_next, Lattice_points_end, Lattice_points_get, NULL, NULL, NULL, &RNA_LatticePoint
};

PointerPropertyRNA rna_Lattice_shape_keys = {
	{(PropertyRNA*)&rna_Lattice_points_u, (PropertyRNA*)&rna_Lattice_points,
...
IntPropertyRNA rna_Lattice_points_u = {
	{(PropertyRNA*)&rna_Lattice_points_v, (PropertyRNA*)&rna_Lattice_shape_keys,
	-1, "points_u", 3, "U",
	...
	0, -1, NULL},
	Lattice_points_u_get, Lattice_points_u_set, NULL, NULL, NULL,
	1, 64, 1, 64, 1, 0, NULL
};

IntPropertyRNA rna_Lattice_points_v = {
	{(PropertyRNA*)&rna_Lattice_vertex_group, (PropertyRNA*)&rna_Lattice_points_u,
	-1, "points_v", 3, "V",
	...
	rna_Lattice_update_size, 0, rna_Lattice_size_editable, NULL,
	0, -1, NULL},
	Lattice_points_v_get, Lattice_points_v_set, NULL, NULL, NULL,
	1, 64, 1, 64, 1, 0, NULL
};

StringPropertyRNA rna_Lattice_vertex_group = {
	{(PropertyRNA*)&rna_Lattice_points_w, (PropertyRNA*)&rna_Lattice_points_v,
	...
	rna_Lattice_update_data, 0, NULL, NULL,
	0, -1, NULL},
	Lattice_vertex_group_get, Lattice_vertex_group_length, Lattice_vertex_group_set, 32, ""
};

IntPropertyRNA rna_Lattice_points_w = {
	{NULL, (PropertyRNA*)&rna_Lattice_vertex_group,
	-1, "points_w", 3, "W",
	...
	rna_Lattice_update_size, 0, rna_Lattice_size_editable, NULL,
	0, -1, NULL},
	Lattice_points_w_get, Lattice_points_w_set, NULL, NULL, NULL,
	1, 64, 1, 64, 1, 0, NULL
};

StructRNA RNA_Lattice = {
	{(ContainerRNA *)&RNA_LatticeModifier, (ContainerRNA *)&RNA_LampTextureSlots,
	NULL,
	{(PropertyRNA*)&rna_Lattice_animation_data, (PropertyRNA*)&rna_Lattice_points_w}},
	"Lattice"	, NULL,NULL
, 3, "Lattice", "Lattice datablock defining a grid for deforming other objects",
	163,
...
/* LatticePoint */
PointerPropertyRNA rna_LatticePoint_rna_type = {
	{(PropertyRNA*)&rna_LatticePoint_co_deform, NULL,
...
FloatPropertyRNA rna_LatticePoint_co_deform = {
	{(PropertyRNA*)&rna_LatticePoint_groups, (PropertyRNA*)&rna_LatticePoint_rna_type,
	...
	NULL, NULL, LatticePoint_co_deform_get, LatticePoint_co_deform_set, NULL, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_LatticePoint_co_deform_default
};

CollectionPropertyRNA rna_LatticePoint_groups = {
	{(PropertyRNA*)&rna_LatticePoint_co, (PropertyRNA*)&rna_LatticePoint_co_deform,
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	LatticePoint_groups_begin, LatticePoint_groups_next, LatticePoint_groups_end, LatticePoint_groups_get, NULL, NULL, NULL, &RNA_VertexGroupElement
};
...
FloatPropertyRNA rna_LatticePoint_co = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	NULL, NULL, LatticePoint_co_get, NULL, NULL, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_LatticePoint_co_default
};

CollectionPropertyRNA rna_LatticePoint_rna_properties = {
	{NULL, (PropertyRNA*)&rna_LatticePoint_co,
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	LatticePoint_rna_properties_begin, LatticePoint_rna_properties_next, LatticePoint_rna_properties_end, LatticePoint_rna_properties_get, NULL, NULL, rna_builtin_properties_lookup_string, &RNA_Property
};

StructRNA RNA_LatticePoint = {
	{(ContainerRNA *)&RNA_Library, (ContainerRNA *)&RNA_LatticeModifier,
	NULL,
	{(PropertyRNA*)&rna_LatticePoint_rna_type, (PropertyRNA*)&rna_LatticePoint_rna_properties}},
	"LatticePoint"	, NULL,NULL
, 0, "LatticePoint", "Point in the lattice grid",
	17,
