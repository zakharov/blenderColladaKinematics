...
StringPropertyRNA rna_VectorFont_filepath = {
	...
	-1, "filepath", 0, "File Path",
	"",
	0,
	PROP_STRING, PROP_FILEPATH|PROP_UNIT_NONE, NULL, 0, {256, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	VectorFont_filepath_get, VectorFont_filepath_length, NULL, 256, ""
};
...
StructRNA RNA_VectorFont = {
	{(ContainerRNA *)&RNA_VectorNodeSocket, (ContainerRNA *)&RNA_ValueNodeSocket,
	NULL,
	{(PropertyRNA*)&rna_VectorFont_filepath, (PropertyRNA*)&rna_VectorFont_packed_file}},
	"VectorFont"	, NULL,NULL
, 3, "Vector Font", "Vector font for Text objects",
	700,
