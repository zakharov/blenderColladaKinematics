...
/* Packed File */
PointerPropertyRNA rna_PackedFile_rna_type = {
	{(PropertyRNA*)&rna_PackedFile_rna_properties, NULL,
...
CollectionPropertyRNA rna_PackedFile_rna_properties = {
	{(PropertyRNA*)&rna_PackedFile_size, (PropertyRNA*)&rna_PackedFile_rna_type,
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	PackedFile_rna_properties_begin, PackedFile_rna_properties_next, PackedFile_rna_properties_end, PackedFile_rna_properties_get, NULL, NULL, rna_builtin_properties_lookup_string, &RNA_Property
};
...
IntPropertyRNA rna_PackedFile_size = {
	...
	PackedFile_size_get, NULL, NULL, NULL, NULL,
	-10000, 10000, INT_MIN, INT_MAX, 1, 0, NULL
};

StructRNA RNA_PackedFile = {
	{(ContainerRNA *)&RNA_Paint, (ContainerRNA *)&RNA_OutflowFluidSettings,
	NULL,
	{(PropertyRNA*)&rna_PackedFile_rna_type, (PropertyRNA*)&rna_PackedFile_size}},
	"PackedFile"	, NULL,NULL
, 0, "Packed File", "External file packed into the .blend file",
	17,
	NULL, (PropertyRNA*)&rna_PackedFile_rna_properties,
	NULL,
	NULL,
