...
BooleanPropertyRNA rna_Brush_use_fixed_texture;
...
void Brush_use_fixed_texture_set(PointerRNA *ptr, int value)
{
	Brush *data= (Brush*)(ptr->data);
...
EnumPropertyRNA rna_Brush_blend = {
	{(PropertyRNA*)&rna_Brush_height, (PropertyRNA*)&rna_Brush_auto_smooth_factor,
...
FloatPropertyRNA rna_Brush_height = {
	{(PropertyRNA*)&rna_Brush_icon_filepath, (PropertyRNA*)&rna_Brush_blend,
	...
	Brush_height_get, Brush_height_set, NULL, NULL, NULL, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.5000000000f, NULL
};

StringPropertyRNA rna_Brush_icon_filepath = {
	{(PropertyRNA*)&rna_Brush_clone_alpha, (PropertyRNA*)&rna_Brush_height,
...
BooleanPropertyRNA rna_Brush_use_edge_to_edge = {
	{(PropertyRNA*)&rna_Brush_use_fixed_texture, (PropertyRNA*)&rna_Brush_direction,
...
BooleanPropertyRNA rna_Brush_use_fixed_texture = {
	{(PropertyRNA*)&rna_Brush_imagepaint_tool, (PropertyRNA*)&rna_Brush_use_edge_to_edge,
	-1, "use_fixed_texture", 3, "Fixed Texture",
	"Keep texture origin in fixed position",
	0,
	PROP_BOOLEAN, PROP_NONE|PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Brush_update, 0, NULL, NULL,
	0, -1, NULL},
	Brush_use_fixed_texture_get, Brush_use_fixed_texture_set, NULL, NULL, 0, NULL
};
...
EnumPropertyRNA rna_Brush_imagepaint_tool = {
	{(PropertyRNA*)&rna_Brush_use_inverse_smooth_pressure, (PropertyRNA*)&rna_Brush_use_fixed_texture,
