...
ELSE(CPPUNIT_INCLUDE_DIR AND CPPUNIT_LIBRARIES)
    ...
    IF(CPPUNIT_CONFIG_EXECUTABLE)
        EXEC_PROGRAM(${CPPUNIT_CONFIG_EXECUTABLE} ARGS --cflags RETURN_VALUE 
...
_return_VALUE OUTPUT_VARIABLE CPPUNIT_INSTALLED_VERSION)
  ...
  macro_ensure_version( ${CPPUNIT_MIN_VERSION} ${CPPUNIT_INSTALLED_VERSION} 
CPPUNIT_INSTALLED_VERSION_OK )

  IF(NOT CPPUNIT_INSTALLED_VERSION_OK)
    MESSAGE ("** CppUnit version is too old: found ${CPPUNIT_INSTALLED_VERSION} 
